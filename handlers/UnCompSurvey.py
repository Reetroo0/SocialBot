...
@router.callback_query(lambda c: c.data.startswith("res_opinion_page:"))
...
@router.callback_query(lambda c: c.data.startswith("res_opinion:"))
...
@router.callback_query(ResumeOpinionState.opinion, lambda c: c.data.startswith("mans:"))
...
@router.callback_query(ResumeOpinionState.opinion, lambda c: c.data.startswith("ans:"))
